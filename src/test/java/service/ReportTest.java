...
public class ReportTest extends AbstractTest {
    ...
    public void createReportDriver() {
        final Object testingData[][] = {
                {
                        "referee1", "description", null, false, "complaint2", null
                },{
                "referee1", "description", null, true, "complaint2", null
        },{
        ...
        for (int i = 0; i < testingData.length; i++)
            this.createReportTemplate((String) testingData[i][0], (String) testingData[i][1], (Collection<Url>) testingData[i][2], (Boolean) testingData[i][3], (String) testingData[i][4], (Class<?>) testingData[i][5]);
    }

    private void createReportTemplate(final String username, final String description, final Collection<Url> attachments, final Boolean isFinal, final String complaint, final Class<?> expected) {
        Class<?> caught;
        caught = null;
